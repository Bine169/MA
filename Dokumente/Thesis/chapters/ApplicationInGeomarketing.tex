...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{images/balanced_notbalanced.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{images/coherent_notcoherent.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{images/compact_notcompact.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{images/salesdistriction1.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{images/salesdistriction2.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{images/whitespot_usecase.jpg}

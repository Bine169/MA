...
All algorithms are implemented with the aim to find an usable calculation procedure for area segmentation processes for the implementation to Geomarketing strategies. All approaches will be compared to find the most promising one. For summarizing the used algorithm they will be shown in Table 3.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{images/basicAreasboth.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/AllocCrit.jpg}
...
\begin{table}[H]
	\begin{tabular}{|C{1.7cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
		\hline
		\multirow{2}*{} & \multicolumn{2}{c|}{number of basic areas} & \multicolumn{2}{p{2\columnwidth/9+2\tabcolsep}|}{\centering{sum of activity measure}} & \multicolumn{2}{c|}{compactness} \tabularnewline
		\cline{2-7}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/AllocDist.jpg}
...
\setvalue{tableTitle=Results of area segmentation using AllocMinDist}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/Eatup.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/smallestcritgetsnearest.jpg}
...
\setvalue{tableTitle=Results of area segmentation using SmallestCritGets-Nearest}
...
\begin{figurevarSize}{Workflow of SmallestCritGets-TrueNearest algorithm}{images/SmallestCritGetsTrueNearestworkflow.jpg}{0.6}\end{figurevarSize}

\newpage
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/smallestcritgetstruenearest.jpg}
...
\setvalue{tableTitle=Results of area segmentation using SmallestCritGets-TrueNearest}
...
\begin{figurevarSize}{Workflow of OutsideSmal-lestCritGetsNearest algorithm}{images/critdistinoutininoutworkflow.jpg}{0.5}\end{figurevarSize}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/outsidesmallestcritgetsnearest.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/EatupDist.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/AllocMinDistLocalSearch.jpg}
